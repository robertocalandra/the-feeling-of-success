...
class grasper():
    ...
    def start_experiment(self):
        ...
        path = "/home/manu/ros_ws/src/manu_research/data/optimize_data/randomized_search_1/"
        ...
        R = np.array(R)
        index = np.argmax(R)
        grasping_success = self.obj_func(X[index])
        file.write("\n")
        file.write(str(X[index]) + " " + str(grasping_success) + "\n")

        self.attempt_lift_(X[index])
