...
xyz_bias = [-0.005, -0.01, 0]  # bias to compensate for sawyer-kinect calibration inaccuracies
...
class grasper():
    ...
    def predict_grasping_success(self, gel0_pre, gel1_pre, gel0_post, gel1_post, im0_pre, im0_post, depth0_pre,
                                 depth0_post):
        net_pr = tensorflow_model_is_gripping.grasp_params.gel_v1()
        checkpoint_file = '/home/manu/ros_ws/src/manu_research/manu_sawyer/src/tensorflow_model_is_gripping/training/net.tf-3999'
        gpu = '/gpu:0'
        # gpu = '/cpu:0'
    ...
    def reset_gripper(self, x):
        ...
        self.gripper.open(speed=30)  # Open gripper
        self.goto_EE_xyz(xyz=des_EE_xyz_above, orientation=des_orientation)
    ...
    def start_experiment(self):
        ...
        path = "/home/manu/ros_ws/src/manu_research/data/optimize_data/"
        nameFile = time.strftime("chance_%Y-%m-%d_%H%M%S")
        ...
        self.attempt_lift_(x)
            ...
            #     des_EE_xyz = des_EE_xyz + delta_xyz
            #     des_EE_xyz[2] = np.maximum(des_EE_xyz[2], lower_bound_z)
