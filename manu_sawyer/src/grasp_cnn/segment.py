import cv2 as cv, numpy as np, planefit, aolib.util as ut, aolib.img as ig, h5py
...
def fit_cylinder(depth0, depth, plane_thresh = 0.02, new_thresh = 0.02, inlier_frac = 0.9925, show = True):
